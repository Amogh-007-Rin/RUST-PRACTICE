//! Integration tests for Module 098 — code review practice.
//!
//! These tests define the correct behavior of `OrderProcessor`. The exercise
//! scaffold contains subtle logic bugs; your job is to find and fix them.

use module_098_exercises::{OrderProcessor, OrderStatus};
