//! Integration tests for module 069: deployment & observability.
...
use module_069_solutions::{build_app_with_observability, AppState};
...
async fn init_tracing_returns_a_guard() {
    let _guard = module_069_solutions::init_tracing();
    drop(_guard);
}
