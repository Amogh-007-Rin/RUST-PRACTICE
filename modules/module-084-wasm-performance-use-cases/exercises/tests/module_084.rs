...
fn grayscale_naive_produces_correct_luminance() {
    ...
    // First pixel: pure red (255,0,0) -> gray = 0.299*255 = 76.245 -> 76
    assert_eq!(gray[0], 76);
    assert_eq!(gray[1], 76);
    assert_eq!(gray[2], 76);
    // Second pixel: pure green (0,255,0) -> gray = 0.587*255 = 149.685 -> 149
...
fn pipeline_output_is_grayscale_blurred() {
    ...
    // After grayscale, all channels equal. After blur of grayscale, still equal.
