...
//! cargo run -p capstone-01-starter -- list
//! cargo run -p capstone-01-starter -- search ada
//! cargo run -p capstone-01-starter -- remove 1
//! ```

use capstone_01_starter::{parse_command, Command, ContactBook};
